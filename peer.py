...
class Peer:
    ...
    def __init__(self, self_addr, tracker_addr, data_crit=lambda new_data, all_data: True):
    ...
    def disconnect(self):
        ...
        print("**Disconencted with other Nodes**")
    ...
    def listen_from_tracker(self):
        ...
        self.tracker_sock.settimeout(1)
        print("**Start listening**")
        while True:
            try:
                track_msg = json.loads(self.tracker_sock.recv(1500).decode())

                # acquire candidate list
                if isinstance(track_msg[0], dict):
                    self.candi_list = [candi for candi in track_msg]
        ...
        while True:
            ...
            try:
                ...
                if peer_msg['type'] == 'BLOCK':
                    print("**Received a block from Node" + addr[0] + "**")
                ...
                # if got a chain
                    ...
                    print("**Received a chain from Node " + addr[0] + "**")
                ...
                # if got a request
                    ...
                    print("**Received a request from Node " + addr[0] + "**")
    ...
    def send_blockchain(self, peer):
        ...
        # send it 
        print("**Blockchain sent to Node " + peer[0] + "**")
    ...
    def send_req(self, peer):
        ...
        # send it
        print("**Request sent to Node" + peer[0] + "**")
